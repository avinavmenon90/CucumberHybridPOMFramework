...
public class ContactUsPage {
	...
	public void fillContactUsForm(String heading, String emailId, String orderReference, String message) {
		Select select = new Select(driver.findElement(subjectHeading)); //dropdown on page as a Select class
		select.selectByVisibleText(heading); //heading matches feature file entry (excel sheet) so look it up in the dropdown
